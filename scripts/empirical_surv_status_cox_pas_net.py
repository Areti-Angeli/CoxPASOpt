...
''' Initialize with updated hyperparameters from empirical search ''' # ------- added
Initial_Learning_Rate = 0.01 # ------- added
L2_Lambda =  0.005 # ------- added
Num_EPOCHS = 1166 # ------- added change to 1166 - same as optuna
Dropout_Rate = [0.7, 0.5]
...
x_combined = torch.cat((x, yevent), dim=1)
