...
def objective(trial):
    ...
    train_x, train_ytime, train_yevent, train_age, _, _ = load_data("/../data/data_inputs/TRAINING.xlsx", dtype)
    eval_x, eval_ytime, eval_yevent, eval_age, _, _ = load_data("/../data/data_inputs/VALIDATION.xlsx", dtype)
