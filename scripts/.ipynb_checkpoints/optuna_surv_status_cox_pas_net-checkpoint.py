...
np.savetxt("/../data/data_outputs/w_sc1.csv", w_sc1, delimiter = ",")
np.savetxt("/../data/data_outputs/w_sc2.csv", w_sc2, delimiter = ",")
np.savetxt("/../data/data_outputs/w_sc3.csv", w_sc3, delimiter = ",")
np.savetxt("/../data/data_outputs/w_sc4.csv", w_sc4, delimiter = ",")
...
np.savetxt("/../data/data_outputs/pathway_node.csv", pathway_node.cpu().detach().numpy(), delimiter = ",")
np.savetxt("/../data/data_outputs/hidden_node.csv", hidden_node.cpu().detach().numpy(), delimiter = ",")
np.savetxt("/../data/data_outputs/hidden_2_node.csv", x_cat.cpu().detach().numpy(), delimiter = ",")
np.savetxt("/../data/data_outputs/lin_pred.csv", lin_pred.cpu().detach().numpy(), delimiter = ",")
