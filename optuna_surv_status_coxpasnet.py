# -*- coding: utf-8 -*-
"""optuna_surv_status_coxpasnet.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1EcKE3SuZF9ay_NsiEsmBQ3cJHf7_6HMs
"""
...
outpath = "/content/drive/MyDrive/.../InterpretCoxPASNet.pt"
...
np.savetxt("/content/drive/MyDrive/.../w_sc1.csv", w_sc1, delimiter = ",")
np.savetxt("/content/drive/MyDrive/.../w_sc2.csv", w_sc2, delimiter = ",")
np.savetxt("/content/drive/MyDrive/.../w_sc3.csv", w_sc3, delimiter = ",")
np.savetxt("/content/drive/MyDrive/.../w_sc4.csv", w_sc4, delimiter = ",")
...
np.savetxt("/content/drive/MyDrive/.../pathway_node.csv", pathway_node.cpu().detach().numpy(), delimiter = ",")
np.savetxt("/content/drive/MyDrive/.../hidden_node.csv", hidden_node.cpu().detach().numpy(), delimiter = ",")
np.savetxt("/content/drive/MyDrive/.../hidden_2_node.csv", x_cat.cpu().detach().numpy(), delimiter = ",")
np.savetxt("/content/drive/MyDrive/.../lin_pred.csv", lin_pred.cpu().detach().numpy(), delimiter = ",")
...
plt.savefig("/content/drive/MyDrive/.../shap_summary_bar_50.svg")

shap.summary_plot(shap_values, x_combined, plot_type="bar", feature_names=feature_names, max_display=20, show=False)
plt.savefig("/content/drive/MyDrive/.../shap_summary_bar_20.svg")