# -*- coding: utf-8 -*-
"""empirical_surv_status_coxpasnet.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1vA5xGZTr_RCFw0IsguFaSKglqbPFh2A6
"""
...
def objective(trial):
    ...
    train_x, train_ytime, train_yevent, train_age, _, _ = load_data("/content/drive/MyDrive/.../TRAINING.xlsx", dtype)
    eval_x, eval_ytime, eval_yevent, eval_age, _, _ = load_data("/content/drive/MyDrive/.../VALIDATION.xlsx", dtype)
    pathway_mask = load_pathway("/content/drive/MyDrive/.../pt_fixed.xlsx", dtype)
...
pathway_mask = load_pathway("/content/drive/MyDrive/.../pt_fixed.xlsx", dtype)
x, ytime, yevent, age, feature_names = load_data("/content/drive/MyDrive/.../entire_data.xlsx", dtype)

outpath = "/content/drive/MyDrive/.../empirical_InterpretCoxPASNet.pt"
...
np.savetxt("/content/drive/MyDrive/.../empirical_w_sc1.csv", w_sc1, delimiter = ",")
np.savetxt("/content/drive/MyDrive/.../empirical_w_sc2.csv", w_sc2, delimiter = ",")
np.savetxt("/content/drive/MyDrive/.../empirical_w_sc3.csv", w_sc3, delimiter = ",")
np.savetxt("/content/drive/MyDrive/.../empirical_w_sc4.csv", w_sc4, delimiter = ",")
...
np.savetxt("/content/drive/MyDrive/.../empirical_pathway_node.csv", pathway_node.cpu().detach().numpy(), delimiter = ",")
np.savetxt("/content/drive/MyDrive/.../empirical_hidden_node.csv", hidden_node.cpu().detach().numpy(), delimiter = ",")
np.savetxt("/content/drive/MyDrive/.../empirical_hidden_2_node.csv", x_cat.cpu().detach().numpy(), delimiter = ",")
np.savetxt("/content/drive/MyDrive/.../empirical_lin_pred.csv", lin_pred.cpu().detach().numpy(), delimiter = ",")
...
plt.savefig("/content/drive/MyDrive/.../empirical_shap_summary_bar_50.svg")

shap.summary_plot(shap_values, x_combined, plot_type="bar", feature_names=feature_names, max_display=20, show=False)
plt.savefig("/content/drive/MyDrive/.../empirical_shap_summary_bar_20.svg")